# Киносмотр — учебный full-stack проект

Проект повторяет структуру прототипа из ЛР «Киносмотр»: авторизация, регистрация, лента рецензий, создание рецензии и профиль.
